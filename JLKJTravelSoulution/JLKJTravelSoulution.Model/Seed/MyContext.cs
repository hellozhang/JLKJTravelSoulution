...
namespace JLKJTravelSoulution.Model.Models
{
    public class MyContext
    {

        private static string _connectionString = File.Exists(@"D:\my-file\dbCountPsw1_1.txt") ? File.ReadAllText(@"D:\my-file\dbCountPsw1_1.txt").Trim() : "server=192.168.10.168;uid=sa;pwd=123;database=WMBlogDB";
        ...
        {
            CreateClassFileByDBTalbe(strPath, "JLKJTravelSoulution.Entity");
        }
        /// <summary>
        /// 功能描述:根据数据库表生产实体类
        /// 作　　者:JLKJTravelSoulution
